...
use ExpImpManagement\ExportersManagement\ExportedFilesHandler\ExportedFilesCompressors\ExportedFilesCompressor;
use ExpImpManagement\ExportersManagement\ExportedFilesHandler\ExportedFilesProcessors\ExportedFilesProcessor;
use ExpImpManagement\ExportersManagement\ExportedFilesHandler\ExporterNeededFilesDeterminers\ExporterNeededFilesDeterminer;
use Exception;
    ...
    //extends TemporaryFilesProcessManager
{
    ...
    {
        if(!$this->filesProcessor) { throw new Exception("Files Processor Is Not Set Yet !"); }
        return $this;
    }
    ...
    {
        if(!$this->filesCompressor) { throw new Exception("Files Compressor Is Not Set Yet !"); }
        return $this;
    }
    ...
    {
        if(!$DataCollection){throw new Exception("DataCollection Must Not Be Set ! "); }
        if( $DataCollection->count() <= 0 ){throw new Exception("DataCollection Must Not Be Empty !");}
        return $this;
    }
